...
load('classpath:/javascript/lib/underscore-min.js');
...
var source = FileHelper.loadFileContent("http://" + InetAddress.localHost.hostName + ":" + port + url.currentModule + "/javascript/underscore/template.html");
